...
export function OtherStockExitWindow({ onSaved }: { onSaved?: () => void }) {
  ...
  return <div className="other-stock-entry-window">
    ...
    <section className="shipment-form-panel"><div className="definition-panel-heading"><div><p className="definition-kicker">ÜRÜN SEÇİMİ</p><h2>Çıkış Ürünü</h2></div></div>
