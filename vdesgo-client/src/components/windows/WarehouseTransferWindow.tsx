...
export function WarehouseTransferWindow({ onSaved }: { onSaved?: () => void }) {
  ...
  const findProduct = () => {
    ...
    const product = products.find((item) => item.code.toLocaleLowerCase('tr-TR') === line.productCode.trim().toLocaleLowerCase('tr-TR'))
  ...
  return <div className="other-stock-entry-window">
    ...
    <section className="shipment-form-panel"><div className="definition-panel-heading"><div><p className="definition-kicker">ÜRÜN SEÇİMİ</p><h2>Transfer Ürünü</h2></div></div>
